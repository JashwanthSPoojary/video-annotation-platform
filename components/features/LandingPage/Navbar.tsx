...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 w-full transition-all duration-300 bg-background/80 backdrop-blur-md border-b">
      <div className="max-w-5xl mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="text-base sm:text-lg font-medium text-foreground">VideoAno</span>
        </Link>
